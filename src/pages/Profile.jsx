    ...
    <>
      {isMobile ? (
        ...
        <div className="w-full h-full flex justify-center items-center p-8">
          <div className="w-full h-full max-w-[1500px] rounded-xl shadow-xl p-4 grid grid-cols-[25%_2px_1fr] gap-4">
              ...
              {credentials.loading ? (
                ...
                <>
                  ...
                  <button className="btn primary w-full">
                    <img src={storeIcon} />
                    <p>Visit Seller Dashboard</p>
                  </button>
                </>
              )}
            </div>
            <div className="w-full bg-gray-500/80"></div>
